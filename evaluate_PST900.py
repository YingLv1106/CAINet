...
if __name__ == '__main__':
    ...
    parser.add_argument("--logdir", default="./checkpoint/pst900", type=str, help="run logdir")
    parser.add_argument("-s", type=bool, default="./checkpoint/pst900", help="save predict or not")
