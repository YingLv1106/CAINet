...
if __name__ == '__main__':
    ...
    # model = mobilenet_v2_shallow()

    x = torch.randn((2, 3, 480, 640))
    x = model.features[0:2](x)
    out1 = model.features[2:4](x)
    out2 = model.features[4:7](out1)
    out3 = model.features[7:11](out2)
    out4 = model.features[11:14](out3)
    out5 = model.features[14:17](out4)
    out6 = model.features[17:18](out5)
